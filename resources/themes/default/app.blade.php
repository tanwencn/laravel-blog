        ...
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
            <div class="container">
                <a href="{{ option('web_url') }}" class="navbar-brand home">
                    <img src="{{ option('web_log', asset('/vendor/laravel-cms/logo2.png')) }}" style="height: 42px;" alt="{{ option('web_name', 'TanwenCMs') }}" class="d-none d-md-inline-block">
                    <img src="{{ option('web_log', asset('/vendor/laravel-cms/logo2.png')) }}" style="height: 42px;" alt="{{ option('web_name', 'TanwenCMs') }}" class="d-inline-block d-md-none">
                    <span class="sr-only">{{ option('web_name', 'TanwenCms') }}</span></a>
                <button type="button" data-toggle="collapse" data-target="#navigation"
                        class="navbar-toggler btn-template-outlined"><span class="sr-only">Toggle navigation</span><i
                            class="fa fa-align-justify"></i></button>
                <div id="navigation" class="navbar-collapse collapse">
                    {{ Widget::menu(['slug' => 'top_menu']) }}
                </div>
