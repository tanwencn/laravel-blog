                ...
                <section class="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <p class="date-comments"><a href="{{ $model->url }}"><i class="fa fa-calendar-o"></i> {{ $model->created_at->format('m-d, Y') }}</a><a href="{{ $model->url }}#comment_list"><i class="fa fa-comment-o"></i> {{ $model->comments_count }} {{ __('Comments') }}</a></p>
                        </div>
                    </div>
