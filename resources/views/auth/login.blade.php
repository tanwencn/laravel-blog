...
<head>
  ...
  <title>{{ trans('admin.login') }} &nbsp;&nbsp; {{ option('web_name') }} &#8212; TanwenCms</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('/vendor/laravel-blog/iCheck/skins/square/blue.css') }}">
  ...
  <div class="login-box-body">
    ...
    <form action="{{ route('admin.login') }}" method="post">
      <div class="form-group has-feedback {!! !$errors->has('email') ?: 'has-error' !!}">
        ...
        <input type="input" class="form-control" placeholder="{{ trans('admin.email') }}" name="email" value="{{ old('email') }}">
